import { decayingEpsilonSoftmaxGreedyPickAction } from "ml-q-learning/lib/pick-action-strategy";
...
async function main() {
  const agent = new DoubleQLearningAgent([Action.Left, Action.Right, Action.Up, Action.Down], decayingEpsilonSoftmaxGreedyPickAction(0.05, 0.99, 3000));
